...
export default {
  ...
  data() {
    return {
      ...
      expenses: [
        ...
        { id: 1, category: 'Bill', name: 'Water', amount: 120, date: '2024-03-30' },
        { id: 1, category: 'Transportation', name: 'Jeep', amount: 13, date: '2024-03-30' },
        { id: 1, category: 'Food', name: 'Lunch', amount: 12.99, date: '2025-03-30' },
        { id: 1, category: 'Food', name: 'Lunch', amount: 12.99, date: '2025-03-30' },
        { id: 1, category: 'Food', name: 'Lunch', amount: 12.99, date: '2025-03-30' },
        { id: 1, category: 'Food', name: 'Lunch', amount: 12.99, date: '2025-03-30' },
        { id: 2, category: 'Transportation', name: 'Bus Ticket', amount: 2.50, date: '2025-03-31' },
        { id: 3, category: 'Bill', name: 'Electricity Bill', amount: 50.00, date: '2025-03-29' },
        { id: 4, category: 'Other', name: 'Coffee', amount: 3.50, date: '2025-03-28' },
      ],
  ...
  computed: {
    ...
    totalAmount() {
      // Compute the total amount of the filtered expenses
  ...
  methods: {
    ...
    // Method to filter expenses based on category
    filterExpenses(category) {
      this.filterCategory = category;
    },
    // Method to filter by date (if required)
    filterExpensesByDate() {
      if (this.filterDate) {
        this.filterCategory = 'all'; // Reset category filter when searching by date
      }
    },
    // Method to format the amount as PHP Peso (₱)
    formatCurrency(value) {
      if (!value) return '₱0.00'; // Handle empty or invalid value
